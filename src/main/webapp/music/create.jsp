...
<DIV class='title_line'>노래 등록</DIV>
...
<FORM name='frm' method='POST' action='./create.do' 
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <input type='text' name='lyricist' value='' required="required" 
               autofocus="autofocus" class="form-control" style='width: 40%;'>
    </div>
  </div>    
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <input type='text' name='composer' value='' required="required" 
               autofocus="autofocus" class="form-control" style='width: 40%;'>
    </div>
  </div>    
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <textarea rows="5" cols="" name='lyrics' class="form-control" style='width: 60%;'></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">   
      <input type='number' name='artistno' value='' required="required" 
               placeholder="" min="1" max=2020 step="1" style='width: 25%;' class="form-control">
     </div>
  </div> 
