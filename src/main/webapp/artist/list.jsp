...
<div class="container-fluid" style="padding: 55px 180px 0px 120px;">
  <div class='title_line'>
    <span style="font-size: 28px; font-weight: 700;">아티스트</span>
...
<div style="width: 100%;">
    ...
    <c:choose>
      <c:when test="${fname.endsWith('jpg') || fname.endsWith('png') || fname.endsWith('gif')}">
        <A href='./read.do?artistno=${artistVO.artistno}'><img src="./storage/${artistVO.fname }" class='img-circle' style="width: 100%; height: 100%;"></A> <br>
