...
<div class="container-fluid" style="padding: 55px 180px 0px 120px;">
  <div class='title_line'>
    <span style="font-size: 28px; font-weight: 700;">앨범 등록 할 아티스트 선택</span>
...
<div style="width: 100%;">
    ...
    <c:choose>
      <c:when test="${fname.endsWith('jpg') || fname.endsWith('png') || fname.endsWith('gif')}">
        <A href='../album/create.do?artistno=${artistVO.artistno}'><img src="./storage/${artistVO.fname }" class='img-circle' style="width: 100%; height: 100%;"></A> <br>
