...
<script type="text/javascript">
 function delete_file(albumno) {
   var sw = confirm("파일을 삭제 하시겠습니까?");
   if (sw == true) {
     location.href="./delete.do?albumno=" + albumno;
   } else {
     alert('파일 삭제를 취소합니다.');
   } 
 }
...
<div class="container-fluid" style="padding: 55px 180px 0px 120px;">
  <div class='title_line'>
    <span style="font-size: 28px; font-weight: 700;">앨범 삭제</span>
...
<div style="width: 100%;">
    ...
    <c:choose>
      <c:when test="${fname.endsWith('jpg') || fname.endsWith('png') || fname.endsWith('gif')}">
        <a href="javascript:delete_file(${albumVO.l_albumno})"><img src="./storage/${albumVO.l_fname }" style="width: 100%; height: 100%;"></A> <br>
