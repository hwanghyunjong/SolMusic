...
<div class="container-fluid" style="padding: 55px 180px 0px 120px;">
  <div class='title_line'>
    <span style="font-size: 28px; font-weight: 700;">앨범</span>
    <div style="float: right;">
      <span class="menu_aside"><A href='./list_create_music.do'>노래 등록</A></span>
...
<div style="width: 100%;">
    ...
    <c:choose>
      <c:when test="${fname.endsWith('jpg') || fname.endsWith('png') || fname.endsWith('gif')}">
        <A href='./read.do?albumno=${albumVO.l_albumno }'><img src="./storage/${albumVO.l_fname }" style="width: 100%; height: 100%;"></A> <br>
