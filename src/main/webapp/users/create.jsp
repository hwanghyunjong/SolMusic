...
<HR style='padding-left:30px;'>
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do' class="form-horizontal">
    ...
    <div class="form-group">
      <label for="userID" class="col-md-2 control-label" style='font-size: 0.9em;'>아이디<span class='text-danger'>*</span></label>    
      <div class="col-md-10">
        <input type='text' class="form-control" name='userID' id='userID' value=''  style='width: 30%;' placeholder="아이디" required="required" autofocus="autofocus">
