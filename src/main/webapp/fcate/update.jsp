...
<div>
  ...
  <section id="tabs">
    ...
    <div class="card-body px-lg-5">
      <form class="form-horizontal" style="color: #757575;" name='frm' method='POST' action='./update.do'>
      ...
      <div class="form-group row">
        ...
        <input type="number"  id="cateno" name="cateno" value='${fcateVO.cateno }' 
                 class="form-control" required="required" placeholder="카테고리번호" disabled style="margin-bottom:10px; width:30%;">
      </div>

      <!-- name -->
      <div class="form-group row">
        <label for="inputEmail3MD" class="col-sm-2 col-form-label">Name. </label>
        <input type="text" id="name" name="name" value='${fcateVO.name }'
                 class="form-control" required="required" placeholder="카테고리이름" style="width:50%;">
      </div>
