    ...
    <UL>
      <c:choose>
        <c:when test="${param.upload_count > 0 }">
          <li class='li_none'>
            <span class='span_success'>새로운 뮤비[${param.video_name}]를 등록했습니다.</span>
          </li>
        </c:when>
        <c:otherwise>
          <li class='li_none_left'>
            <span class='span_fail'>새로운 뮤비[${param.video_name}] 등록에 실패했습니다.</span>
          </li>
           <li class='li_none_left'>
      ...
      <LI class='li_none'>
        <br>
        <button type='button' onclick="location.href='./create.do'">새로운 앨범 등록</button>
