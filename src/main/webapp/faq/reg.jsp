              ...
              <table class="table" style="margin-top: 10px;">
                  ...
                  <td style="border-top: 2px solid #4c4c4c; padding: 10px 20px; color: #3a3635; background-color: #fff;">
                    <div class="categoryArea" style="overflow: hidden;">
                      ...
                      <select name='faq_categrp' id="faq_categrp" required="required">
                          <option value="이용권/요금">1. 이용권/요금</option>
                          <option value="결제/해지/환불">2. 결제/해지/환불</option>
                          <option value="회원정보/로그인">3. 회원정보/로그인</option>
                          <option value="플레이어/재생목록">4. 플레이어/재생목록</option>
                          <option value="서비스문의/오류">5. 서비스문의/오류</option>
                      </select>
                      </span>
                    </div>
                ...
                <tr>
                  ...
                  <td style="border-top: 1px solid #ebebea; padding: 10px 20px; color: #3a3635; background-color: #fff;">
                    <input class="form-control" type="text" required="required" name='faq_title' id='faq_title' placeholder="제목을 입력하세요">
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="border-top: 1px solid #ebebea; padding: 10px 20px; color: #3a3635; background-color: #fff;">
                    <input class="form-control" type="text" name='faq_word' value='' required="required" placeholder="Keyword">
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="border-top: 1px solid #ebebea; border-bottom: 1px solid #ebebea; padding: 10px 20px; color: #3a3635; background-color: #fff;">
                    <div class="form-group">
                      <textarea class="ckeditor" name='faq_content'
                        id='faq_content' rows='6' cols='70'></textarea>
                    </div>
                  </td>
                </tr>
              </table>
