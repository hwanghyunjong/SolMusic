        ...
        <ul>
          <c:choose>
            <c:when test="${param.cnt == 1 }">
              <LI class='li_none'><span class='qna_span_success'>문의가 정상적으로 등록되었습니다.</span><br>
            ...
            <c:otherwise>
              <LI class='li_none'><span class='qna_span_fail'>문의 등록에 실패했습니다.</span></LI>
            </c:otherwise>
          </c:choose>
          ...
          <c:choose>
            <c:when test="${param.cnt == 1 }">
              <div class="qna_btn_bottom">
                ...
                <button class="btn" type="button" id="qna_btn_info"onclick="location.href='./reg.do'">등록하기</button>
              </div>
            </c:when>
            <c:otherwise>
